    ...
    competitor_observations: [{
      ...
      matrix_row: {
        ...
        ad_visibility_sample: {
          ...
          raw: { immutable_pointer: "urn:mox:owner-artifact:e2e-competitor-search", sha256: `sha256:${"a".repeat(64)}`, media_type: "image/png", byte_length: 2048 },
          extraction: { method: "manual_span", ad_marker: "Реклама", locator: "image region 30,20,1100,300" },
          provenance: { obtained_by: "owner", obtained_at: observedAt },
          approval: null,
        },
      },
