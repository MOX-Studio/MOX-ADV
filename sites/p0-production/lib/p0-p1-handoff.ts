...
async function verifyAttempt(value: P0P1CampaignAttempt, admitted: boolean) {
  if (!exactKeys(value, ["attempt_kind", "campaign_revision", "lineage", "frozen_auction_protocol", "final_state"])
    ...
    || !exactKeys(value.lineage.analytics_evidence.hashes, ["input_root_sha256", "sources_sha256", "claims_sha256", "evidence_sha256", "conflicts_sha256", "gaps_sha256", "competitor_matrix_sha256", "product_catalog_sha256", "focus_opportunities_sha256", "market_evidence_sha256"])
