...
Key references:
- @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/ui-brand.md (display patterns)
- @/Users/sviridov/Documents/MOX-ADV/.pi/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md" "/Users/sviridov/Documents/MOX-ADV/.pi/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/user-profiling.md`
...
Reference: @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/sviridov/Documents/MOX-ADV/.pi/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/sviridov/Documents/MOX-ADV/.pi/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/sviridov/Documents/MOX-ADV/.pi/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/sviridov/Documents/MOX-ADV/.pi/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/sviridov/Documents/MOX-ADV/.pi/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.pi/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/sviridov/Documents/MOX-ADV/.pi/CLAUDE.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.pi/CLAUDE.md` but may be overridden by config or `--output`.)
