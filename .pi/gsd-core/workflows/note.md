...
- **Global scope**: `/Users/sviridov/Documents/MOX-ADV/.pi/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sviridov/Documents/MOX-ADV/.pi/notes/`)
...
2. Glob `/Users/sviridov/Documents/MOX-ADV/.pi/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sviridov/Documents/MOX-ADV/.pi/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sviridov/Documents/MOX-ADV/.pi/notes/` — works in any directory
