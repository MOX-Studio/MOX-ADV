...
ones). Reference: @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/sviridov/Documents/MOX-ADV/.pi.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/sviridov/Documents/MOX-ADV/.pi/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/templates/spec.md.
