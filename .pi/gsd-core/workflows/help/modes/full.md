...
- Generates `./.pi/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.pi/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `/Users/sviridov/Documents/MOX-ADV/.pi/notes/` globally)
