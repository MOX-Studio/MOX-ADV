...
<required_reading>
@/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/ai-frameworks.md
@/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/sviridov/Documents/MOX-ADV/.pi/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/sviridov/Documents/MOX-ADV/.pi/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/sviridov/Documents/MOX-ADV/.pi/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/sviridov/Documents/MOX-ADV/.pi/agents/gsd-eval-planner.md for instructions.
