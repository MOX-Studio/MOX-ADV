...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.pi/skills/sketch-findings-[project]/`
...
3. Check if `./.pi/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.pi/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.pi/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.pi/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.pi/skills/` with SKILL.md, references/, sources/
