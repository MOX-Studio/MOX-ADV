...
**Test:** Could a different Claude instance execute without asking clarifying questions? If not, add specificity. See @/Users/sviridov/Documents/MOX-ADV/.pi/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
