...
// hardcode the canonical path `@~/.pi/gsd-core/...` (references, workflows,
...
// `~/.pi/gsd-core/` is never created and every @-include resolves to
...
// `~/.pi/gsd-core/` exists and its immutable subdirs (bin, contexts,
...
// are the directories `@~/.pi/gsd-core/<subdir>/...` includes point into.
...
/**
 * Ensure the canonical `~/.pi/gsd-core/` path exposes the bundled subdirs.
 *
